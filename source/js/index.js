import { LoginByToken,LoginChecked,GetData} from "./moudle.js";
...
async function initialize(){
    ...
    if(filmsArry.length%5==0){
        makefilmMidboxNum = filmsArry.length%5
    }else{
        makefilmMidboxNum = filmsArry.length%5 + 1
    }
